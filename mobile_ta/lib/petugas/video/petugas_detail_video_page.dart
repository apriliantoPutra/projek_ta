...
class PetugasDetailVideoPage extends StatefulWidget {
  final int videoId;
  const PetugasDetailVideoPage({required this.videoId, super.key});

  @override
  State<PetugasDetailVideoPage> createState() => _PetugasDetailVideoPageState();
}

class _PetugasDetailVideoPageState extends State<PetugasDetailVideoPage> {
