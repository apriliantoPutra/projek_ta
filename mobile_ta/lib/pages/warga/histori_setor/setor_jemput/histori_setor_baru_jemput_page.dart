...
class HistoriSetorBaruJemputPage extends StatefulWidget {
  final int id;
  final String tanggal;
  final String catatan;
  const HistoriSetorBaruJemputPage({
    required this.id,
  ...
  @override
  State<HistoriSetorBaruJemputPage> createState() =>
      _HistoriSetorBaruJemputPageState();
}
