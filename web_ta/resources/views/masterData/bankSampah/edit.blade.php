        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-3">
                <h1 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                    <i class="ri-search-line"></i> Edit Data
                </h1>
            </div>

            <form action="{{ route('Bank-Sampah-Update', $bank_sampah->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('put')
                <div>
                    ...
                    <input type="text" name="nama_bank_sampah" id="nama_bank_sampah"
                        value="{{ old('nama_bank_sampah', $bank_sampah->nama_bank_sampah) }}"
                ...
                <div>
                    ...
                    <textarea id="deskripsi_bank_sampah" name="deskripsi_bank_sampah" rows="4"
                        class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>{{ old('deskripsi_bank_sampah', $bank_sampah->deskripsi_bank_sampah) }}</textarea>
                </div>

                <div>
                    <label for="alamat_bank_sampah" class="block text-sm font-medium text-gray-700 mb-1">Alamat Bank
                        Sampah</label>
                    <input type="text" name="alamat_bank_sampah" id="alamat_bank_sampah"
                        value="{{ old('alamat_bank_sampah', $bank_sampah->alamat_bank_sampah) }}"
                        class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                </div>

                <div>
                    <label for="koordinat_bank_sampah" class="block text-sm font-medium text-gray-700 mb-1">Koordinat Bank
                        Sampah</label>
                    <input type="text" name="koordinat_bank_sampah" id="koordinat_bank_sampah"
                        value="{{ old('koordinat_bank_sampah', $bank_sampah->koordinat_bank_sampah) }}"
